...
const setCliente = async (req,res)  => {
    ...
    const response = await pool.query('INSERT INTO cliente (nombre, apellido, dni, correo) VALUES ($1, $2, $3, $4)',[nombre, apellido, dni, correo]);
    res.status(200).json({
        message:'cliente agregado correctamente',
        body:{
            espacio_servicio:{nombre, apellido, dni, correo}
        }
    });    
    console.log(req);
}
